...
export function Navbar() {
  ...
  return (
    <nav className="vertical-navbar">
      {/* Logo at the top */}
      <Link to="/" className="vertical-navbar-logo">
        <img src={threadsLogo} alt="Threads" width="28" height="28" />
      </Link>
      
      {/* Navigation items - centered in the navbar */}
      ...
      {/* Bottom icons */}
      <div className="vertical-navbar-bottom">
        {/* Pin Icon */}
        <Link to="/pins" className={`nav-item ${isActive('/pins') ? 'active' : ''}`}>
          <svg viewBox="0 0 24 24" aria-hidden="true">
